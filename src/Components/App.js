      ...
      <div className="App">
        ...
        <h2 className="Header">BOMBERMAN</h2>
          <ul className="nav nav-tabs">
            <li data-toggle="tooltip" data-placement="left" title="Tooltip on left" role="presentation" className="active" className="home"><NavLink to='/' onlyActiveOnIndex>Home</NavLink></li>
